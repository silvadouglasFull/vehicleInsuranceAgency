import type { AwardCoverage, InfoFipe, Installments, RCF, Summary, UseDataAccordion } from "@components/accordion/suhai/layouts/hooks/useDataAccordion/types";
import type { State } from "@components/accordion/suhai/layouts/hooks/useGetParamsScreen/types";

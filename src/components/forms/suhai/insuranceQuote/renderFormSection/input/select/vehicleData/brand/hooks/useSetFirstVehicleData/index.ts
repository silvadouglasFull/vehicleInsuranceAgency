...
import type { UseSetFirstVehicleData, UseSetFirstVehicleDataProps } from '@components/forms/suhai/insuranceQuote/renderFormSection/input/select/vehicleData/brand/hooks/useSetFirstVehicleData/types';

...
import { useSelectInput } from "@components/forms/suhai/insuranceQuote/renderFormSection/input/select/personalData/sexo/hooks/useSelectInput";
import { useSetOptions } from "@components/forms/suhai/insuranceQuote/renderFormSection/input/select/personalData/sexo/hooks/useSetOptions";
...
export const SelectSexo: React.FC<Select2BootStrap> = ({
    isClearable = true,
    isSearchable = true,

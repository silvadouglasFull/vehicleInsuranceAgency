...
export type Type = "text" | "number" | "email" | "tel" | "number" | "select" | "number" | "fipe" | "cpf" | "marca" | "modelo" | "zeroKm" | "tipoUtilizacao" | "possuiOutroVeic" | "estadoCivil" | "estadoCivilPrincipalCondutor"

...
import type { UseSetFirstVehicleData, UseSetFirstVehicleDataProps } from '@components/forms/suhai/insuranceQuote/vehicleData/select/brand/hooks/useSetFirstVehicleData/types';
